...
translate([17,17.5,19]) rotate([90,0,0]) cylinder(h = 5, d=25, $fn = A, center = true); 
translate([0,17.5,-9]) rotate([90,0,0]) cylinder(h = 5, d=25, $fn = A, center = true); 
translate([17,13.5-0.125,9+10]) rotate([90,0,0]) cylinder(h = 3+0.25, d1=25, d2=9, $fn = A, center = true); 
   
//wall connecting 2 bearings    
translate([17/2,17.5,5]) rotate([0,-58.7,0]) cube([32,5,25], center = true);    
    
    
translate([17/2+11.8,17.5,5]) rotate([0,-58.7-45,0]) cube([32,5,25], center = true);      
...
//triangle support
translate([-17,15,0]) rotate([0,0,30]) resize([14,17,5]) cylinder(h = 5, d=15, $fn = 3, center = true);

}



//guide elastic band remedy
translate([17,13.5-0.125-2.75,9+10-7.5]) rotate([0,-2.4*3,0]) translate([-17-1,-3/8+2.75,9-19]) cube([22,4,20], center = true);

translate([17,13.5-0.125-2.75+3,9+10-7.5]) rotate([0,-2.4*3,0]) translate([-17+0.25,-3/8+1.75-2.3,9-19]) rotate([0,0,35]) cube([22,6.29+5,22], center = true);
...
difference(){
union(){    
translate([-34,12,-3.5]) rotate([0,0,0]) cylinder(h = 8, d=12, $fn = B, center = true);
 
translate([-34,15,-3.5]) rotate([0,0,0]) cube([12,6,8], center = true); 
  
}    
//hole through baseplate
translate([-34,12,-3]) rotate([0,0,0]) cylinder(h = 25, d=3.2, $fn = B, center = true);
...
translate([-34,12,4.5]) cube([12.3,12.3,8], center = true);
