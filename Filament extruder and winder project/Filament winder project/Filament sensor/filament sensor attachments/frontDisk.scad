...
for(i=[0:3]) rotate([-i*90,0,0]) translate([-2.5,12.5,0]) rotate([0,90,0]) cylinder(h = 5, d=6, $fn = 30, center = true);   
    
for(i=[0:3]) rotate([-i*90,0,0]) translate([2.5,12.5,0]) rotate([0,90,0]) cylinder(h = 5, d=3.2, $fn = 30, center = true);
...
for(i=[0:3]) rotate([-i*90,0,0]) translate([-2.5,12.5,0]) rotate([0,90,0]) cylinder(h = 12, d=6, $fn = 30, center = true);  
...
for(i=[0:3]) rotate([-i*90,0,0]) translate([2.5,12.5,0]) rotate([0,90,0]) cylinder(h = 12, d=3.2, $fn = 30, center = true);


translate([0,0,0]) rotate([0,90,0]) cylinder(h = 12, d=10, $fn = 45, center = true);
