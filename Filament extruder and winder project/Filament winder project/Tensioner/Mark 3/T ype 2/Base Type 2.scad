...
translate([13,-12,2.5]) cube([60,5,10], center = true);
 
//Slanted wall 
difference(){    
translate([23,0,7.5]) cube([80,5,10], center = true);   
...
for(i=[-1]) translate([50,i*12,0])cylinder(h = 23.5, d=18,$fn = A, center = true);
...
for(i=[-1]) translate([50,i*12,0])cylinder(h = 60, d=5.25, $fn = A, center = true);
...
for(i=[0:20])translate([10+17.5,12,0])rotate([0,0,i*1]) translate([50-10-17.5,0,0])cylinder(h = 10, d=18.25, $fn = A, center = true);
...
//Front cylinder
translate([40-17.5,0,10-3.5])cylinder(h = 12, d=18, $fn = A, center = true);
...
//cube center
translate([15,0,10]) cube([20,15,5], center = true);


//latch hook
rotate([0,0,5]) translate([-5,7.5+5,10]) cube([10,10,5], center = true);

}

//holes
translate([40-17.5,0,10])cylinder(h = 60, d=5.25, $fn = A, center = true);
...
rotate([0,0,5]) rotate([0,0,-20]) translate([-10.4,-4+5+1,10-0.75]) cube([10,22,5], center = true);
