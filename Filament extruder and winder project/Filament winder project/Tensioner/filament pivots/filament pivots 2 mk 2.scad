...
difference(){
translate([17,i*12,0]) cube([25,5,21], center = true);

translate([20.75,i*12,13.26])rotate([0,60,0]) cube([50,6,30], center = true);
...
for(i=[-1,1]) translate([22,i*(12-5),0])cylinder(h = 60, d=5.25, $fn = 180, center = true);
