...
for(i=[0,1]) mirror([0,i,0])translate([0,-37.5/2,0]){
...
//rod holder 
translate([10,,0]) rotate([0,90,0]) cylinder(h = 20, d=15, $fn = 30, center = true);  
...
//skrew outer frame    
for(i=[1:3])rotate([i*90,0,0])translate([0,31,0]) rotate([0,90,0]) cylinder(h = 10, d=31.2, $fn = 60, center = true);     
...
//skrew diameter
translate([0,0,0]) for(i=[1:3])rotate([i*90,0,0])translate([0,31,0]) rotate([0,90,0]) cylinder(h = 11, d=6.3, $fn = 30, center = true); 
    
//hex skrew end
translate([2.5,0,0]) for(i=[1:3])rotate([i*90,0,0])translate([0,31,0]) rotate([0,90,0]) cylinder(h = 5, d=11.5, $fn = 6, center = true); 
