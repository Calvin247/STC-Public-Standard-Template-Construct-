...
translate([28,-28,107.5+15]) rotate([90,0,0]) cylinder(h = 16, d=6.25, $fn = 180, center = true);

//hexagon
translate([28,-2.5-28,107.5+15]) rotate([90,0,0]) cylinder(h = 5, d=12, $fn = 30, center = true);
