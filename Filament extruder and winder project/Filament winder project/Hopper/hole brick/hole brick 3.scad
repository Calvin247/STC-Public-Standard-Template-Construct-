...
translate([0,0,0])cylinder(h = 100, d=8.2, $fn = 180, center = true);     

translate([0,0,0])rotate([0,90,0])cylinder(h = 40, d=3, $fn = 180, center = true);  
    
    
for(i=[-1,1])translate([5,0,i*40])cube([30,21,70], center = true);     
