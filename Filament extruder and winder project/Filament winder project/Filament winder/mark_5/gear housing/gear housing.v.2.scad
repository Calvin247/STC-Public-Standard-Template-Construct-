...
translate([0,0,-20]) gearboxBottom();

translate([0,0,5]) gearboxTop();
...
difference(){    
cylinder(h = 45, d=20, $fn = 180, center = true); 
   
//cube([20,20,45], center = true);    


cylinder(h = 46, d=5.25, $fn = 180, center = true);  
}
...
//Plate 
translate([15-5,0,-10+5.5])cube([110+50,100,4+11], center = true);   
}
