...
translate([80,0,45])BearingBlock();
    

for(i=[-1,1])translate([-60,i*40,45])extentionblock();

for(i=[-1,1])translate([-60,i*40,10])spacer();
    
for(i=[-1,1])translate([80,i*40,10])spacer();
...
difference(){    
union(){    
cube([20,100,8], center = true);   
translate([-20,0,0])cube([20,30,8], center = true);   
}  

for(i=[-1,1])translate([0,i*40,0])cylinder(h = 9, d=5.2, $fn = 180, center = true);


translate([-80+63.25,0,0])cylinder(h = 9, d=14, $fn = 180, center = true);
...
cylinder(h = 56, d=5.25, $fn = 180, center = true);  
...
//Plate 
translate([15-5,0,-10])cube([110+50,100,4], center = true);   
}
...
//extra eliminations/////   
translate([-30-30,0,-10])cube([28,50
,5], center = true); 
...
//connector holes/////
for(i=[0,1])mirror([0,i,0])translate([60+20,40,0]) cylinder(h = 100, d=5.25, $fn = 180, center = true);
    
for(i=[0,1])mirror([0,i,0])translate([-30-30,40,0]) cylinder(h = 100, d=5.25, $fn = 180, center = true);
/////////////////////
...
//Plate 
translate([15-5,0,30])cube([110+50,100,4], center = true);     
   
difference(){   
translate([35-35+63.25,0,24.5])cylinder(h = 7, d=22.25+8, $fn = 180, center = true);   
...
translate([0,0,0]) for(i=[0:3])rotate([0,0,90+i*90])translate([31,0,0]) cylinder(h = 80, d=6.25, $fn = 180, center = true);
...
translate([35-35+63.25,0,24.5+4])cylinder(h = 7, d=22.25, $fn = 180, center = true);
