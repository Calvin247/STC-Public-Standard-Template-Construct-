...
//middle hole    
translate([0,-50+5,0]) rotate([90,0,0]) cylinder(h = 30, d=22.25, $fn = 180, center = true); 
...
//pillars    
rotate([0,0,0]) translate([0,30-5,0]) cube([42+10,55-10,5+2+3], center = true);
  
rotate([0,90,0]) translate([0,30-5,0]) cube([42+10,55-10,5+2+3], center = true); 
...
translate([0,22.5,0]) rotate([90,0,0]) cylinder(h = 60, d1=22.25, d2=22.25, $fn = 180, center = true); 
