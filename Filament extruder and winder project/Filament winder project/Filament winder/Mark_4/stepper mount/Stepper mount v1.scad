...
translate([16,0,0]) rotate([0,0,90]){
...
translate([29.25,0,-2.5]) rotate([0,0,0])translate([0,0,0]) cube([48+20.5,42.4+10,42.4+5], center = true);
...
translate([29,0,0]) rotate([0,0,0])translate([0,0,0]) cube([48,42.4,42.4], center = true);



translate([29,0,0]) rotate([0,0,0])translate([0,0,0]) cube([48,60,15], center = true);

translate([29,0,0]) rotate([0,0,0])translate([0,0,0]) cube([48,15,60], center = true);


rotate([0,0,90]) translate([0,-60,0]){
//holes for stepper motor screws
translate([15.5,0,15.5]) rotate([90,0,0]) cylinder(h = 20, d=3, $fn = 180, center = true);
...
translate([60,0,0]) rotate([0,90,0]) cylinder(h = 60, d1=23, d2=23, $fn = 180, center = true); 
