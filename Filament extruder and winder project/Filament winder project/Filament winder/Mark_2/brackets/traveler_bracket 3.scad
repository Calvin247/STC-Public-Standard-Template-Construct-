...
//side smoothing
 rotate([0,25,0]) rotate([0,0,32]) translate([-17,0,5]) cube([20,28,35], center = true); 
  
//side smoothing2    
rotate([0,25,0]) rotate([0,0,-34+30.5]) translate([17-0.02,0,5]) cube([17,35-12,35], center = true);      
    
    
}

//cylinder
rotate([5,25,0]) translate([0,0,5]) cylinder(h = 25, d=17, $fn = 180, center = true);      
}    

//bottom hole
rotate([5,25,0]) translate([0,0,5]) cylinder(h = 50, d=8+0.3, $fn = 180, center = true);
