...
difference(){
translate([0,0,7-1.5])cube([17,17+6,17+14-3], center = true);
...
union(){    
translate([0,0,-17])cube([17,17+17,17], center = true);
translate([0,0,-8.5]) rotate([45,0,0]) cube([17,24,24], center = true);    
...
difference(){
union(){
rotate([0,0,0]) translate([0,(-50+5+3)/2,19.37]) cylinder(h = 25, d=17, $fn = 180, center = true); 
rotate([0,0,0]) translate([0,-(-50+5+3)/2,19.37]) cylinder(h = 25, d=17, $fn = 180, center = true);
translate([0,0,19.37]) cube([17,50-5-3,25], center = true);
    
    
translate([0,0,12]) rotate([45,0,0]) cube([17,25,25], center = true);    

}


rotate([0,0,0]) translate([0,(-50+5+3)/2,19.37]) cylinder(h = 26, d=8+0.25, $fn = 180, center = true); 
