...
translate([-95,25,-19])rotate([90,0,0])cylinder(h = 10, d=38, $fn = 180, center = true);  


translate([(-95-50)/2,25,-19/2])rotate([0,67.1,0])cube([38,10,48], center = true);    
...
//hole for weights
translate([-95,25,-19])rotate([90,0,0])cylinder(h = 11, d=8.25, $fn = 180, center = true); 
