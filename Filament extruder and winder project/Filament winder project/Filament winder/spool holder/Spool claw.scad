...
translate([0,0,0]) cylinder(h = 50, d=8+0.3, $fn = 180, center = true);

 translate([0,0,2.5]) rotate([0,90,45]) translate([0,0,19-5]) cylinder(h = 6, d=7-0.5, $fn = 6, center = true); 
...
for(i=[1,2,3,9,10,11]) rotate([0,0,22.5*i]) translate([0,35,-10]) cube([5,60,10], center = true);
}   
