...
translate([30,-0.6,0]){
difference(){
rotate([0,-15,0]) translate([0,0,0]) cylinder(h = 28, d=17, $fn = 180, center = true);   
    
rotate([0,-15,0]) translate([0,0,0]) cylinder(h = 50, d=8+0.25, $fn = 180, center = true);
...
difference(){
rotate([-25,15,0]) translate([0,0,0]) cylinder(h = 28, d=17, $fn = 180, center = true);   
    
rotate([-25,15,0]) translate([0,0,0]) cylinder(h = 50, d=8+0.25, $fn = 180, center = true);
...
rotate([90,0,0]) cylinder(h = 5+10, d1=16+10,d2=16+8+4.89, $fn = 180, center = true);
...
translate([30,-0.6,0]) rotate([0,-15,0]) translate([0,0,0]) cylinder(h = 50, d=9, $fn = 180, center = true);
...
translate([0,22.5,0]) rotate([90,0,0]) cylinder(h = 40, d1=11+5, d2=23, $fn = 180, center = true); 
...
rotate([90,0,0]) translate([0,0,0]) cylinder(h = 55-10, d1=26-1, d2=42.5, $fn = 180, center = true); 
...
translate([-30,3,0]) rotate([-25,15,0]) translate([0,0,0]) cylinder(h = 50, d=9, $fn = 180, center = true); 
