...
difference(){
translate([0,0,0]) rotate([0,90,0]) cylinder(h = 84+10-1.5, d=20, $fn = 90, center = true); 
...
translate([0,8,0]) rotate([0,90,0]) resize([13+1.6,24,100]) cylinder(h = 100, d=10, $fn = 180, center = true);   

rotate([-90,0,0]) translate([30,0,7.7]) cube([24,15-1.5+1,15], center = true);
...
translate([-44.5-15,0,30+12]) rotate([0,90,0]) cylinder(h = 5, d=30+29, $fn = 90, center = true);  

translate([-44.5+5-15,0,30+12]) rotate([0,90,0]) cylinder(h = 5, d1=30+29, d2=15, $fn = 90, center = true); 
...
translate([-44.5-15+5,0,30+12]) rotate([0,90,0]) cylinder(h = 5, d=9, $fn = 90, center = true);

translate([-44.5-15,0,30+12]) rotate([0,90,0]) cylinder(h = 5, d=5.25, $fn = 90, center = true);
