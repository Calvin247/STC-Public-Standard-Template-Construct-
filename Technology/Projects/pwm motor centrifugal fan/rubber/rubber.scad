...
difference(){
translate([0,0,-12+0.2-3.5-2.1-0.5]) cube([121+2,121+2,6], center = true); 




translate([0,0,-12+0.2-3.5]){
difference(){
union(){    
difference(){
...
//////////////////////////////////
    ...
    //translate([0,0,-1.5]) cube([66+0.5,66+0.5,3+3], center = true);
    
    translate([0,0,-1.5]) cube([60,60,6], center = true);
...
translate([0,0,-12+0.2-3.5-1.5]) translate([0,0,-1.5]) cube([60-2,60-2,9], center = true);
